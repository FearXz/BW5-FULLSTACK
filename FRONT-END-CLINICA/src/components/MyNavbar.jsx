    ...
    <Navbar expand="lg" className=" navbar navbar-expand-lg  CustomNavBar" style={{ zIndex: 1000 }}>
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <NavDropdown title="Prodotti" id="basic-nav-dropdown" className="me-auto custom-dropdown">
            <NavDropdown.Item to={"/Prodotto"} as={NavLink} className={""}>
              Lista prodotti
            </NavDropdown.Item>
            <NavDropdown.Item to={"/Prodotto/Create"} as={NavLink} className={""}>
              Aggiungi prodotto
            </NavDropdown.Item>
          </NavDropdown>

          <div className="d-flex align-items-center">
            <NavLink className="text-dark mx-2" to={"carrello"}>
