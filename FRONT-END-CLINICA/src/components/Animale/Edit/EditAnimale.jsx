...
export const EditAnimale = () => {
	...
	const proprietari = useSelector(
		(state) => state.proprietario.listaProprietari
	);
			...
			<Form onSubmit={handleSubmit}>
				...
				<Form.Group className="mb-3">
					...
					<Form.Select
						...
						onChange={(e) =>
							setIdProprietario(e.currentTarget.value)
						}>
				...
				<Form.Group className="mb-3">
					...
					<Form.Control
						...
						value={SpecieAnimale}
						onChange={(e) =>
							setSpecieAnimale(e.currentTarget.value)
						}
					/>
				</Form.Group>
				<Form.Group className="mb-3">
					...
					<Form.Control
						...
						value={ColoreAnimale}
						onChange={(e) =>
							setColoreAnimale(e.currentTarget.value)
						}
					/>
				</Form.Group>
				<Form.Group className="mb-3">
